#This script was made to fix broken data path links in an mxd. This situation often arises when moving from computer to computer or when data paths/names change.
#The first half creats dictionaries for all of the gdbs that have the data that the mxd needs to be redirected to. 
#The second half uses this dictionary to fix any broken links.
